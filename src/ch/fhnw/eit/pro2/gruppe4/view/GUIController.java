...
public class GUIController {
	...
	public void calculate() {
		...
		double Ks = Double
				.parseDouble(view.leftPanel.inputPanel.tfKs.getText());
		double Tu = Double
				.parseDouble(view.leftPanel.inputPanel.tfTu.getText());
		double Tg = Double
				.parseDouble(view.leftPanel.inputPanel.tfTg.getText());
		double Tp = 0.0;
		// TODO: Tp noch verarbeiten.
		// double Tp =
		// Double.parseDouble(view.leftPanel.controllerValuePanel.phaseResponsePanel.tfTp.getText());
		int controllerTyp;
