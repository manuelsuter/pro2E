...
public class ViewInputPanel extends JPanel implements ActionListener, ItemListener {
	...
	public ViewInputPanel(Controller controller) {
		...
		add(new JLabel("<html><i>K<sub>s</sub></i></html>"), new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
				GridBagConstraints.LINE_START, GridBagConstraints.NONE, new Insets(
						10, 10, 5, 10), 0, 0));		//.setText("K"+"<html><center><font face=\"Arial, Verdana, Sans Serif\" color=\"#FFFFFF\" size=\"-2\">Please insert</font></center></html>");
